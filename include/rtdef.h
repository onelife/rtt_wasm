...
#if defined(CONFIG_ARDUINO) || defined(__EMSCRIPTEN__)
#define FINSH_VAR_EXPORT(name, type, desc)
#endif
#endif
...
enum
{
    ...
    RTGRAPHIC_PIXEL_FORMAT_RGB2I = RTGRAPHIC_PIXEL_FORMAT_GRAY4,
    RTGRAPHIC_PIXEL_FORMAT_GRAY16,
    RTGRAPHIC_PIXEL_FORMAT_RGB4I = RTGRAPHIC_PIXEL_FORMAT_GRAY16,
    RTGRAPHIC_PIXEL_FORMAT_RGB332,
    RTGRAPHIC_PIXEL_FORMAT_RGB8I = RTGRAPHIC_PIXEL_FORMAT_RGB332,
